-- Создайте БД и импортируйте в phpMyAdmin или: mysql -u root -p < sql/schema.sql

CREATE DATABASE IF NOT EXISTS inclusive
...
CREATE TABLE IF NOT EXISTS categories (
  ...
  diagram_icon_class VARCHAR(64) NOT NULL DEFAULT 'text-primary' COMMENT 'цвет иконки на главной (text-primary, text-danger, …)',
  created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (id),
...
CREATE TABLE IF NOT EXISTS documents (
  id INT UNSIGNED NOT NULL AUTO_INCREMENT,
  section VARCHAR(32) NOT NULL COMMENT 'slug из categories',
